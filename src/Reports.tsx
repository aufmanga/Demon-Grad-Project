...
function Reports({ onLogout }: { onLogout: () => void }) {
  ...
  const menuItems = [
    ...
    { 
      ...
      expanded: true,
      subItems: [
        { label: 'تقارير المبيعات', active: currentReport === 'sales', path: '/reports' },
        { label: 'تقارير المشتريات', active: currentReport === 'purchases', path: '/reports/purchases' },
        { label: 'أكثر العملاء شراءً', active: currentReport === 'top-customers', path: '/reports/top-customers' },
        { label: 'أكثر الأصناف مبيعاً', active: currentReport === 'top-products', path: '/reports/top-products' },
        { label: 'تقارير الأرباح', active: currentReport === 'profits', path: '/reports/profits' },
        { label: 'تقارير العملاء', active: currentReport === 'customers', path: '/reports/customers' },
      ]
    },
